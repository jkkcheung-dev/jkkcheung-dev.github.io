...
export const resumeJP: Resume = {
    name: "ジャック, チョウ カキット",
    title: "ソフトウェアエンジニア | Software Engineer",
    location: "香港",
    ...
    about: "ソフトウェアエンジニアとして、これまで主にJavaのSpringBootを使ったバックエンド開発や、React.jsでのフロントエンド開発に携わってきました。前職では、開発だけでなく、ELKとRedisを活用したログの管理システムや、PrometheusとGrafanaを使った自動監視システムを構築しました。これにより、障害対応にかかる時間を大幅に減らすことができました。現職でも、開発以外、AWSやCI/CD、Kubernetesなどを利用した開発・テスト環境の実装を担当しています。また、若手エンジニアのサポートも担当してきました。",
    education: {
        school: "香港大学",
